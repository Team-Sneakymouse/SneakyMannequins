...
class ConfigManager {
    ...
    fun getImageStoragePath(): Path {
        val relativePath = config.getString("images.storage-path", "../web/images/") ?: "../web/images/"
    ...
    fun getImageUrl(imageName: String): String {
        val urlPrefix = config.getString("images.url-prefix", "http://localhost:8080/images/") ?: "http://localhost:8080/images/"
    ...
    fun getImageUrlPrefix(): String {
        return config.getString("images.url-prefix", "http://localhost:8080/images/") ?: "http://localhost:8080/images/"
    }
