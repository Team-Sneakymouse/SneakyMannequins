                ...
                renderManager.handleProjectedPixels(
                        ...
                        spawn = { proj, entityId ->
                                ...
                                if (flyIn != null) {
                                        ...
                                        val riseOffset =
                                                Vector3f(baseTranslation).add(0f, -sh * 1.5f, 0f)
                                        display.setTransformation(
                                                com.mojang.math.Transformation(
                                                        riseOffset,
                                                        rotation,
                                ...
                                display.setTextOpacity(
                                        0.toByte()
                                ) // hide glyph; rely on background color
                                display.setWidth(1f)
                                ...
                                if (flyIn != null || isRiseUp) {
                                        ...
                                        plugin.server.scheduler.scheduleSyncDelayedTask(
                                                ...
                                                Runnable {
                                                        ...
                                                        display.setTransformationInterpolationDelay(
                                                                0
                                                        )
                                                        display.setTransformationInterpolationDuration(
                                                                interpTicks
                                                        )
                                                        connection.send(
                                                                ClientboundSetEntityDataPacket(
                        ...
                        remove = { proj, entityId ->
                                ...
                                if (flyOut != null) {
                                        ...
                                        val yawRad = Math.toRadians(-proj.yaw.toDouble()).toFloat()
                                        val pitchRad =
                                                Math.toRadians(proj.pitch.toDouble()).toFloat()
                                        val rotation =
                                                Quaternionf().rotateY(yawRad).rotateX(pitchRad)
